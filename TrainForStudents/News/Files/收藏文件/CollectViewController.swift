...
import UIKit
import SwiftyJSON
class CollectViewController: NewsBaseViewController,UIScrollViewDelegate {
...
//        if var dataArray = UserDefaults.standard.stringArray(forKey: "collectData") {
...
//            //
//            //            if dataArray.contains(json.description) {
//            //                guard let index = dataArray.index(of: json.description) else { return  }
//            //                dataArray.remove(at: index)
//            //            }else{
//            //                dataArray.append(json.description)
//            //            }
//            UserDefaults.standard.set(dataArray, forKey: "collectData")
//        }else{
//            var array = [String]()
//            array.append(json.description)
//            UserDefaults.standard.set(array, forKey: "collectData")
//        }
//        
