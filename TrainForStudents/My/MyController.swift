...
//        }
        ...
        jds = JSON([["icon":"我的-选择","title":"修改个人资料","link":"changePersonInfoView"],["icon":"双箭头-右蓝","title":"切换至学生端","link":"studentTabbar"],["icon":"紧急","title":"退出系统","link":"loginView"],["icon":"紧急","title":"我的学员","link":"myStudentView"]]).arrayValue
